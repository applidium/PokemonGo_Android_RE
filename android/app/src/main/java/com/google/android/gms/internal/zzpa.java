        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case C1401R.styleable.LoadingImageView_circleCrop /*2*/:
                    ...
                    zza(com.google.android.gms.internal.zzoz.zza.zzbT(parcel.readStrongBinder()), parcel.readInt() != 0 ? (UserAddressRequest) UserAddressRequest.CREATOR.createFromParcel(parcel) : null, parcel.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(parcel) : null);
