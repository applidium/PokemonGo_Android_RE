...
public final class BillboardSupportFragment extends DialogFragment {
    ...
    /* renamed from: com.upsight.android.marketing.internal.billboard.BillboardSupportFragment.1 */
    static /* synthetic */ class C09671 {
        static final /* synthetic */ int[] f271x3f5ad3de;

        static {
            f271x3f5ad3de = new int[LayoutOrientation.values().length];
            try {
                f271x3f5ad3de[LayoutOrientation.Portrait.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f271x3f5ad3de[LayoutOrientation.Landscape.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
        }
    }

    public BillboardSupportFragment() {
        this.mRootView = null;
        this.mContentViewContainer = null;
    }

    public static BillboardSupportFragment newInstance(Context context, Set<Dimensions> set) {
        BillboardSupportFragment billboardSupportFragment = new BillboardSupportFragment();
        Bundle bundle = new Bundle();
        if (set != null) {
            for (Dimensions dimensions : set) {
                if (dimensions.width > 0 && dimensions.height > 0) {
                    switch (C09671.f271x3f5ad3de[dimensions.layout.ordinal()]) {
